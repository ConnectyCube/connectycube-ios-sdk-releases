...
/**
 A notification that enables the broadcast of information to registered observers between extensions with the same ConnectyCube application id.
 ...
 @note Based on Darwin notification center.
 
 @see https://developer.apple.com/library/content/documentation/Darwin/Conceptual/MacOSXNotifcationOv/DarwinNotificationConcepts/DarwinNotificationConcepts.html#//apple_ref/doc/uid/TP40005947-CH5-SW1
 */
NS_SWIFT_NAME(DarwinNotificationCenter)
@interface CYBDarwinNotificationCenter : NSObject

/**
 Returns the process’s default darwin notification center.
 */
@property (nonatomic, readonly, class) CYBDarwinNotificationCenter *defaultCenter;
