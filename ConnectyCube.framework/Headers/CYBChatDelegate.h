...
/**
 Called whenever CYBChat did connect.
 */
- (void)chatDidConnect;
...
/**
 Called whenever CYBChat connection error happened.
...
/**
 Called whenever CYBChat connection disconnect happened.
...
/**
 Called whenever CYBChat did accidentally disconnect.
...
/**
 Called whenever new private message was received from CYBChat.
...
/**
 Called whenever new system message was received from CYBChat.
 
 @note Will be called only on recipient device
 
 @param message Message that was received from Chat
 */
- (void)chatDidReceiveSystemMessage:(CYBChatMessage *)message;
...
/**
 ...
 @param dialogID CYBChatDialog identifier
 */
- (void)chatRoomDidReceiveMessage:(CYBChatMessage *)message
...
/**
 ...
 @param contactList Contact list
 */
- (void)chatContactListDidPopulate:(CYBContactList *)contactList;
/**
...
/**
 CYBChatDelegate protocol definition.
 
 @remark This protocol defines methods signatures for callbacks.
 
 @discussion Implement this protocol in your class and add [CYBChat instance].addDelegate to your implementation instance to receive callbacks from CYBChat.
 */
NS_SWIFT_NAME(ChatDelegate)
@protocol CYBChatDelegate <NSObject, CYBChatConnectionProtocol, CYBChatReceiveMessageProtocol,
CYBChatContactListProtocol, CYBChatPrivacyProtocol, CYBChatPresenceProtocol>
